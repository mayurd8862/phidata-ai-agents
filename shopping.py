...
agent = Agent(
    ...
    tools=[FirecrawlTools(api_key="fc-b318f69f13114a9797f0848dc4364c1a")],
)
agent.print_response(
    "I am looking for running shoes with the following preferences: Color: Black Purpose: Comfortable for long-distance running Budget: Under Rs. 5,000"
)
